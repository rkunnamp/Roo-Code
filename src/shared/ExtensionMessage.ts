...
// Represents a section of content (like file content or tool output)
// that can be tagged, summarized, and potentially pruned from history.
export interface TaggedContent {
	id: string // Unique identifier for this content block
	type: "file_content" | "tool_result" | "other" // Type of content
	source?: string // e.g., file path or tool name
	summary?: string // Optional summary generated by the LLM
	fullContent: string // The complete original content
}
