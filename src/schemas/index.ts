...
export const experimentIds = ["search_and_replace", "insert_content", "powerSteering", "contentSummarization"] as const
...
const experimentsSchema = z.object({
	...
	contentSummarization: z.boolean(), // Add new experiment key
})
